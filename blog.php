...
<body>
	...
	<main>
		...
		<?php
			$blog_execution = mysqli_query($conn, "SELECT *, DATE_FORMAT(creato_il, '%W %d %M %Y, %H:%i') AS niceDate FROM blog ORDER BY nome_blog ASC") or die("Connessione fallita: " . mysqli_error($conn));
